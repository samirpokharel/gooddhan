...
class _$RemoteResponseTearOff {
  ...
  _NotModified<T> notModified<T>({required int totalPage}) {
    return _NotModified<T>(
      totalPage: totalPage,
    );
  }

  _WithNewData<T> withNewData<T>(T data, {required int totalpage}) {
...
mixin _$RemoteResponse<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int totalPage) notModified,
    required TResult Function(T data, int totalpage) withNewData,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function()? noConnection,
    TResult Function(int totalPage)? notModified,
    TResult Function(T data, int totalpage)? withNewData,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$_NotModified<T> extends _NotModified<T> {
  const _$_NotModified({required this.totalPage}) : super._();
  ...
  @override
  String toString() {
    return 'RemoteResponse<$T>.notModified(totalPage: $totalPage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(totalPage));
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return notModified?.call(totalPage);
  }
...
abstract class _NotModified<T> extends RemoteResponse<T> {
  const factory _NotModified({required int totalPage}) = _$_NotModified<T>;
...
class _$_WithNewData<T> extends _WithNewData<T> {
  const _$_WithNewData(this.data, {required this.totalpage}) : super._();
  ...
  @override
  String toString() {
    return 'RemoteResponse<$T>.withNewData(data: $data, totalpage: $totalpage)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return withNewData(data, totalpage);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return withNewData?.call(data, totalpage);
  }
...
abstract class _WithNewData<T> extends RemoteResponse<T> {
  const factory _WithNewData(T data, {required int totalpage}) =
      _$_WithNewData<T>;
