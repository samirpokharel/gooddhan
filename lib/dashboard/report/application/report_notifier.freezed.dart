...
class _$ReportStateTearOff {
  ...
  _Success success(Report report) {
    return _Success(
      report,
    );
  }

  _Failed failed({GooddhanFailure? failure}) {
    return _Failed(
      failure: failure,
    );
  }
...
/// @nodoc
class __$InitialCopyWithImpl<$Res> extends _$ReportStateCopyWithImpl<$Res>
...
abstract class _Initial extends ReportState {
...
abstract class _Loading extends ReportState {
...
/// @nodoc
class __$SuccessCopyWithImpl<$Res> extends _$ReportStateCopyWithImpl<$Res>
...
class _$_Success extends _Success {
  const _$_Success(this.report) : super._();
  ...
  @override
  String toString() {
    return 'ReportState.success(report: $report)';
  }
...
abstract class _Success extends ReportState {
  const factory _Success(Report report) = _$_Success;
...
/// @nodoc
class __$FailedCopyWithImpl<$Res> extends _$ReportStateCopyWithImpl<$Res>
...
class _$_Failed extends _Failed {
  ...
  @override
  String toString() {
    return 'ReportState.failed(failure: $failure)';
  }
...
abstract class _Failed extends ReportState {
  const factory _Failed({GooddhanFailure? failure}) = _$_Failed;
